...
def group_df_normal_pairs(alignment, version_pattern, full_vs_seed):
    ...
    if len(pfam) > 1:
        ...
        if len(pairs_df) > 0:
            ...
            elif full_vs_seed == 'rec':
                output_path = f"./data/normal_pairs/rec_align/pfam_pairs_AD_missense{version_pattern}/pairs_by_pfam_code"
            elif full_vs_seed == 'selected':
                output_path = f"./data/normal_pairs/SELECTED_align/pfam_pairs_AD_missense{version_pattern}/pairs_by_pfam_code"
            else:
    ...
    if len(pfam) > 1:
        ...
        if groups_list:
            ...
            if full_vs_seed == 'full':
                ...
                output_path = f"./data/homologous_pairs/REC_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}/pairs_by_pfam_code"
            elif full_vs_seed == 'selected':
                output_path = f"./data/homologous_pairs/SELECTED_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}/pairs_by_pfam_code"
