...
def get_output_path(pair_type, full_vs_seed, version_pattern, aa_2_compute):
    ...
    if pair_type == 'blosum':
        ...
        elif full_vs_seed == 'hmmer':
            data_path = f"./data/homologous_pairs/HMMER_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}/pairs_by_pfam_code"
            output_path = f"./data/homologous_pairs/HMMER_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}"
        elif full_vs_seed == 'selected':
            data_path = f"./data/homologous_pairs/SELECTED_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}/pairs_by_pfam_code"
            output_path = f"./data/homologous_pairs/SELECTED_align/blosum62_{aa_2_compute}/pfam_pairs_interpro_+score{version_pattern}"
        ...
        if full_vs_seed == 'full':
            ...
            data_path = f"./data/normal_pairs/HMMER_align/pfam_pairs_AD_missense{version_pattern}/pairs_by_pfam_code"
            output_path = f"./data/normal_pairs/HMMER_align/pfam_pairs_AD_missense{version_pattern}"
        elif full_vs_seed == 'selected':
            data_path = f"./data/normal_pairs/SELECTED_align/pfam_pairs_AD_missense{version_pattern}/pairs_by_pfam_code"
            output_path = f"./data/normal_pairs/SELECTED_align/pfam_pairs_AD_missense{version_pattern}"
...
def get_input_path(only_quanti, pair_type, full_vs_seed, version_pattern, aa_2_compute):
    ...
    if only_quanti != 'quanti':
        ...
        if full_vs_seed == 'full':
            ...
            data_path = f"../5_Split_entries_by_align/data/HMMER_align/pfam_groups_interpro{version_pattern}"
        elif full_vs_seed == 'selected':
            data_path = f"../5_Split_entries_by_align/data/SELECTED_align/pfam_groups_interpro{version_pattern}"
        else:
