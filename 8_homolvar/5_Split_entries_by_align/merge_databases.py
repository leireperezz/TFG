...
clinvar_path = f"{data_path}/clinvar_pos_align_REC.txt"
...
gnomad_pattern = f"{data_path}/gnomad_r4_pos_align_REC{version_pattern}.txt"
...
output_file = f"{output_path}/merged_db_interpro_REC{version_pattern}.txt"
