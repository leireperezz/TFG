# Merge and compare quality metrics (conservation, BLOSUM, gaps) between REC and SEED alignments (lowercase as gaps)
...
seed_path = "../A_Score_and_conservation/results/seed_cons_score_%_gaps_lowercase_as_gap.csv"
