# Calculate conservation percentage, BLOSUM62 score, and gap percentage for REC and SEED alignments (lowercase as gaps)
...
datasets = {
    "REC": ("../../6_2_Process_gaps/lowercase_as_gap/results/rec_and_seed/REC_filtered", "./results/rec_cons_score_%_gaps_lowercase_as_gap.csv"),
    "SEED": ("../../6_2_Process_gaps/lowercase_as_gap/results/rec_and_seed/SEED_filtered", "./results/seed_cons_score_%_gaps_lowercase_as_gap.csv")
}
