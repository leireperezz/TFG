# Plot conservation percentage improvement distribution for REC vs SEED alignments (lowercase as gaps)
...
# Input file containing REC vs SEED conservation comparison
input_path = "../B_Merge_and_comparison/results_merge/conservation_rec_vs_seed_comparison.csv"
...
# Keep only REC vs SEED conservation percentage improvement
df_long = pd.DataFrame({
    "comparison": ["REC vs SEED"] * len(df),
    "improvement_percent": df["REC_vs_SEED_conservation_%_improvement"]
})
...
plt.title("Distribution of conservation percentage improvement (REC vs SEED) (lowercase as gap)")
