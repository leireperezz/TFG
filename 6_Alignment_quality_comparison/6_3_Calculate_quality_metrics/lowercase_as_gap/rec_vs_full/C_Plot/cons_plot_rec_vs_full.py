# Plot conservation percentage improvement distribution for REC vs FULL alignments (lowercase as gaps)
...
plt.title("Distribution of conservation percentage improvement (REC vs FULL) (lowercase as gap)")
