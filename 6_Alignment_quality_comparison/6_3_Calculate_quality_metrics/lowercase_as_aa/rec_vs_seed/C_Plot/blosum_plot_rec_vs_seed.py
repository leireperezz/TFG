# Plot BLOSUM62 score comparison distributions (percentage improvement and absolute difference) for REC vs SEED alignments
...
plt.title("Distribution of percentage change in BLOSUM62 score (REC vs SEED) (lowercase as aa)")
...
plt.ylabel("Number of alignments")
plt.title("Distribution of BLOSUM62 score differences (REC vs SEED) (lowercase as aa)")
plt.xticks(rotation=45)
plt.tight_layout()
