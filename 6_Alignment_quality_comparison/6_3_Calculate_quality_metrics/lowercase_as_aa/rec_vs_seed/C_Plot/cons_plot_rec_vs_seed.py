# Plot conservation percentage improvement distribution for REC vs SEED alignments
...
plt.title("Distribution of conservation percentage improvement (REC vs SEED) (lowercase as aa)")
