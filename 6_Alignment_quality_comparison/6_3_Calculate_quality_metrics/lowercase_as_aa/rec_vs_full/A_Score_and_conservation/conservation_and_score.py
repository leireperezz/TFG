# Calculate conservation percentage, BLOSUM62 score, and gap percentage for REC and FULL alignments (lowercase as amino acids)
...
datasets = {
    "REC": ("../../6_2_Process_gaps/lowercase_as_aa/results/rec_and_full/REC_filtered", "./results/rec_cons_score_%_gaps_lowercase_as_aa.csv"),
    "FULL": ("../../6_2_Process_gaps/lowercase_as_aa/results/rec_and_full/FULL_filtered", "./results/full_cons_score_%_gaps_lowercase_as_aa.csv")
}
