# Merge and compare quality metrics (conservation, BLOSUM, gaps) between REC and FULL alignments
...
full_path = "../A_Score_and_conservation/results/full_cons_score_%_gaps_lowercase_as_aa.csv"
